...
local_resource('bazel', cmd='bazel', labels=['bazel'])
# local_resource('bazel-modquery', cmd='bazel modquery', labels=['bazel'])
local_resource('bazel-gazelle', cmd='bazel run //:gazelle', labels=['bazel'])
local_resource('bazel-clean', trigger_mode=TRIGGER_MODE_MANUAL, cmd='bazel clean', deps=['.'], labels=['bazel'])
# local_resource('bazel-query', cmd='bazel query //...', deps=['.'], labels=['just'])
local_resource('bazel-version', cmd='bazel version', deps=['.'], labels=['bazel'])
local_resource('bazel-info', cmd='bazel info', deps=['.'], labels=['bazel'])
local_resource('bazel-build', cmd='bazel build //:all', deps=['.'], labels=['bazel'])
local_resource('bazel-test', cmd='bazel test //:all', deps=['.'], labels=['bazel'])
local_resource('bazel-query', cmd='bazel query "//:*"', deps=['.'], labels=['bazel'])
...
local_resource('bazel-mobile-install', cmd='bazel mobile-install', deps=['.'], labels=['bazel'])
